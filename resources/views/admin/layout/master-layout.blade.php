...
<head>
    <meta charset="utf-8" />
    <title>@yield('title') | Gym Webiste</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="HR OWL" name="description" />
    <meta content="HR OWL" name="author" />
    <meta name="csrf-token" content="{{ csrf_token() }}">

    <!-- App favicon -->
    <link rel="shortcut icon" href="public/assets/images/gym-logo-1.jpg">
...
<body>
    ...
    <!-- Vector Map js -->
    <script src="public/assets/vendor/admin-resources/jquery.vectormap/jquery-jvectormap-1.2.2.min.js"></script>
    <script src="public/assets/vendor/admin-resources/jquery.vectormap/maps/jquery-jvectormap-world-mill-en.js"></script>
